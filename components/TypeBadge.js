...
return (
        <View style={[styles.container, {backgroundColor: globalStyles["type"+props.type]}]}>
...
const styles = StyleSheet.create({
  container: {
      ...
      icon: {
        ...
        filter: 'invert(99%) sepia(0%) saturate(2%) hue-rotate(224deg) brightness(101%) contrast(100%)'
      },
