    ...
    return (
        ...
        <BottomSheetScrollView contentContainerStyle={styles.container}>
            ...
            <View style={styles.buttonContainer}>
                <TouchableOpacity
                    style={[styles.btn, props.sort == 'numLow' ? styles.btnSelected : styles.btnUnselected]}
                    onPress={() => sortBy('numLow')}>
                    <Text style={[styles.btnText, props.sort == 'numLow' ? { color: globalStyles.textwhite } : { color: globalStyles.textgrey }]}>Smallest number first</Text>
                </TouchableOpacity>

                <TouchableOpacity 
                style={[styles.btn, props.sort == 'numHigh' ? styles.btnSelected : styles.btnUnselected]}
                onPress={() => sortBy('numHigh')}>
                    <Text style={[styles.btnText, props.sort == 'numHigh' ? { color: globalStyles.textwhite } : { color: globalStyles.textgrey }]}>Highest number first</Text>
                </TouchableOpacity>

                <TouchableOpacity 
                style={[styles.btn, props.sort == 'a-to-z' ? styles.btnSelected : styles.btnUnselected]}
                onPress={() => sortBy('a-to-z')}>
                    <Text style={[styles.btnText, props.sort == 'a-to-z' ? { color: globalStyles.textwhite } : { color: globalStyles.textgrey }]}>A-Z</Text>
                </TouchableOpacity>

                <TouchableOpacity 
                style={[styles.btn, props.sort == 'z-to-a' ? styles.btnSelected : styles.btnUnselected]}
                onPress={() => sortBy('z-to-a')}>
                    <Text style={[styles.btnText, props.sort == 'z-to-a' ? { color: globalStyles.textwhite } : { color: globalStyles.textgrey }]}>Z-A</Text>
                </TouchableOpacity>
            </View>
